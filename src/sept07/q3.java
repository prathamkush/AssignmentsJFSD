...
public class q3 {
    public static void main(String[] args) {
        ...
        int n = in.nextInt();
        HashSet<Pair<String,String>> s = new HashSet<>();
